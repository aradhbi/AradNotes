...
<section id="dashboard" class="bg-gray-100 min-h-screen p-6 font-sans text-right rounded-2xl">
    ...
    <a href="{{ route("admin.posts.create") }}" id="openModalBtn" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg shadow-lg transition duration-300 ease-in-out transform hover:scale-105 ">
        افزودن پست
    </a>
        ...
        <table class="min-w-full bg-white rounded-lg shadow-md overflow-hidden" dir="ltr">
            <thead>
                <tr>
                    ...
                    <th class="px-4 py-2">وضیعت انتشار</th>
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-100 w-full min-h-32">
                    ...
                    <td class="border px-4 py-2">
                        ...
                        <span class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-green-600/20 ring-inset">منتشر شده</span>
                        @else
